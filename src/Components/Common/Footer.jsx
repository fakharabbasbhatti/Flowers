      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li><a href="#" className="hover:text-pink-400 transition">Product
</a></li>
            <li><a href="#" className="hover:text-pink-400 transition">
Our Outlets</a></li>
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <a href="https://wa.me/923229234045?text=Hi!%20I%20want%20to%20know%20more%20about%20your%20services." target="_blank" rel="noopener noreferrer" className="p-2.5 bg-gray-800 rounded-full hover:bg-green-600 transition shadow-md"><Icon path={icons.whatsapp} /></a>
        ...
        <div>
          ...
          <div className="space-y-4 text-[13px] border-l-2 border-gray-800 pl-4">
            ...
            <p className="flex items-center gap-2"><span className="text-pink-500 font-bold">T:</span> +92 322 9234045</p>
            <p className="flex items-center gap-2"><span className="text-pink-500 font-bold">E:</span> fakharabbasbhatti333@gmail.com</p>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-gray-800 pt-10 mt-10">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8 text-center md:text-left">
          ...
          <p>Designed by <br /> <span className="text-pink-500 font-bold">Fakhar Abbas </span></p>
          <div className="flex flex-wrzap justify-center gap-4">
